<template>
    <art-widget title="Recent Followers">
        <template slot="body">
...
import artFollower from './follower-item'
export default {
    name: 'followers_widget',
    components: {
        artWidget,
        artFollower
    },
